...
@Component({
  selector: 'app-admin-bereich-produkte',
  templateUrl: './admin-bereich-produkte.component.html',
  styleUrls: ['./admin-bereich-produkte.component.css']
})
export class AdminBereichProdukteComponent implements OnInit {
